...
![](images/Pasted image 20250301180012 1.png)

che in quello discreto

![](images/Pasted image 20250301180203 1.png)
...
![](images/Pasted image 20250301171038 1.png){width=300px}
...
## Generare dati data una distribuzione di probabilità
...
## Studiare la distribuzione di un campione

Dato un campione di dati osservati 

![](images/Pasted image 20250301184249 1.png){width=400px}

è possibile studiare la sua distribuzione attraverso l'istogramma dei dati 

![](images/Pasted image 20250301184615 1.png){width=400px}
...
![](images/Pasted image 20250302192343 1.png){width=400px}

Invertendo gli assi, otteniamo una CdF empirica "grossolana"

![](images/Pasted image 20250302192418 1.png){width=400px}

Scalando i dati tra 0 e 1, si ricava la ECDF, che approssima la CdF reale, che ha generato il campione

![](images/Pasted image 20250302192552 1.png){width=400px}
...
corrispondono ai quantili teorici, calcolati tramite la funzione inversa $\Phi^{-1}$ della
distribuzione $\mathcal{N}(0,1)$, e ai dati osservati ordinati.

![](images/Pasted image 20250302193324 1.png){width=400px}
